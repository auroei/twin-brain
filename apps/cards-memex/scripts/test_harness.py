...
def test_format(raw_answer: str, confidence: float = 0.8, days_old: int = 0):
    ...
    from cards_memex.paths import CONFIG_DIR
...
def test_classify(thread_text: str):
    ...
    from cards_memex.paths import CONFIG_DIR, ROLE_FILE
    from cards_memex.config_loader import load_all_configs
...
def test_retrieve(query: str, n_results: int = 5):
    ...
    from cards_memex.paths import CONFIG_DIR, KNOWLEDGE_BASE_DIR
    from cards_memex.config_loader import load_all_configs
...
def test_answer(query: str):
    ...
    from cards_memex.paths import CONFIG_DIR, KNOWLEDGE_BASE_DIR, ROLE_FILE
    from cards_memex.config_loader import load_all_configs
...
def compare_prompts(prompt_name: str):
    ...
    from cards_memex.paths import PROMPTS_DIR
