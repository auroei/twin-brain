...
App-specific maintenance, testing, and utility scripts for the Cards Strategy Bot.
...
- All scripts should be run from the `apps/cards-memex/` directory
- Scripts load `.env` from the app directory (`apps/cards-memex/.env`)
