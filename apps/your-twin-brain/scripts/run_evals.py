#!/usr/bin/env python3
"""
Evaluation runner for your-twin-brain app.
...
from twin_brain.paths import ENV_FILE, KNOWLEDGE_BASE_DIR, ROLE_FILE
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate your-twin-brain RAG system performance"
    )
    parser.add_argument(
        "--eval-file",
        type=str,
    ...
    print("⚡️ twin-brain Evaluation Runner")
    print("=" * 60)
