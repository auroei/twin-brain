...
# Import from twin_brain package
from twin_brain.paths import (
    ENV_FILE, CONFIG_DIR, DATA_DIR, KNOWLEDGE_BASE_DIR,
    PROMPTS_DIR, ROLE_FILE, WATCHED_THREADS_FILE,
    ensure_data_dir,
)
from twin_brain.rbac import load_rbac_config, get_user_role
from twin_brain.config_loader import load_all_configs
from twin_brain.services import initialize_services
from twin_brain.handlers import (
    create_mention_handler,
    create_message_handler,
    create_reaction_handler,
)
from twin_brain.slack_utils import fetch_thread
...
if __name__ == "__main__":
    print("⚡️ twin-brain Bot - Startup Sequence")
    print("=" * 60)
